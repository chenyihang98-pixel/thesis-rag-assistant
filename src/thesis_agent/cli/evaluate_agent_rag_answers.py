"""Evaluate explicit Agent rag_answer task."""
...
from thesis_agent.evaluation.agent_rag_answer_eval import evaluate_agent_rag_answer_cases, load_agent_rag_answer_cases, write_agent_rag_answer_eval_summary
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Evaluate Agent rag_answer wrapper.")
    parser.add_argument("--cases", default="data/evaluation/agent_rag_answer_cases.jsonl")
    parser.add_argument("--index", default="data/index/structured_tfidf_index.pkl")
    ...
    parser.add_argument("--output", default="outputs/eval/agent_rag_answer_eval.json")
...
def main() -> None:
    ...
    cases = load_agent_rag_answer_cases(Path(args.cases))
    summary = evaluate_agent_rag_answer_cases(
        cases,
    ...
    write_agent_rag_answer_eval_summary(summary, Path(args.output))
